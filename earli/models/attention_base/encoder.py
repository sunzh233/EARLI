...
class GraphAttentionEncoder(nn.Module):
    ...
    def __init__(
            ...
            sdpa_fn=None,
            eight_rounding=False, config=None,
            ):
    ...
    def forward(
            self, td: TensorDict, mask: Union[Tensor, None] = None, vector_mask = None,
            ) -> Tuple[Tensor, Tensor]:
        ...
        # Process embedding
        final_embeddings = self.net(init_h, mask, vector_mask=vector_mask)
